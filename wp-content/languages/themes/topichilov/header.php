...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header" role="banner">
		<hgroup>
			...
			<p class="site-description"><?php echo get_option('tp_sub_header'); ?></p>
                        <div id="phones">
                                <?php tp_the_phones(); ?>
                        </div>
                        <br class="clear" />
		...
		<nav id="site-navigation" class="main-navigation" role="navigation">
			<div class="title3 menu-toggle"><?php _e( 'Menu', 'twentytwelve' ); ?></div>
  ...
  ga('create', 'UA-46402947-1', 'topichilov.ru');
  ga('send', 'pageview');
...
(function (d, w, c) {
    (w[c] = w[c] || []).push(function() {
        try {
            w.yaCounter23359762 = new Ya.Metrika({id:23359762,
                    webvisor:true,
                    clickmap:true,
...
<noscript><div><img src="//mc.yandex.ru/watch/23359762" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
